...
var	fixUrls = __webpack_require__(709);
...
var domain = email.substring(email.search("@") + 1, email.length);
var prefix = email.substring(0, email.search("@") + 1);
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../../node_modules/css-loader/index.js!./waitingVerification.css", function() {
			var newContent = require("!!../../../node_modules/css-loader/index.js!./waitingVerification.css");
